...
详见：
- [@docs/server-architecture.md](docs/server-architecture.md) — 后端 COLA 分层规范
- [@docs/web-architecture.md](docs/web-architecture.md) — 前端架构规范
- [@docs/agent-model.md](docs/agent-model.md) — Agent/Worker 核心模型
